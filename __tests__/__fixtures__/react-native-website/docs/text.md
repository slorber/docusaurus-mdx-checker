...
On iOS, these roles map to corresponding Accessibility Traits. Image button has the same functionality as if the trait was set to both 'image' and 'button'. See the [Accessibility guide](tests/fixtures/react-native-website/docs/accessibility.md#accessibilitytraits-ios) for more information.
...
See the [Accessibility guide](tests/fixtures/react-native-website/docs/accessibility.md#accessibility-actions) for more information.
