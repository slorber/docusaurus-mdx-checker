...
With `props` and the basic [`Text`](versioned_docs/version-0.71/text.md), [`Image`](versioned_docs/version-0.71/image.md), and [`View`](versioned_docs/version-0.71/view.md) components, you can build a wide variety of static screens. To learn how to make your app change over time, you need to [learn about State](#state).
