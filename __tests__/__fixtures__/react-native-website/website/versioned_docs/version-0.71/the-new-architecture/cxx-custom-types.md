...
[**Codegen**](versioned_docs/version-0.71/the-new-architecture/pillars-codegen.md) for C++ Turbo Native Modules does support struct generators, so you can simplify the code above in `NativeSampleModule.h` to:
