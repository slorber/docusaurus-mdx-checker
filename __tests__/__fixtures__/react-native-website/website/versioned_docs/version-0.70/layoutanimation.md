...
The `config` parameter is an object with the keys below. [`create`](versioned_docs/version-0.70/layoutanimation.md#create) returns a valid object for `config`, and the [`Presets`](versioned_docs/version-0.70/layoutanimation.md#presets) objects can also all be passed as the `config`.
...
- `type`, the [animation type](versioned_docs/version-0.70/layoutanimation.md#types) to use
- `property`, the [layout property](versioned_docs/version-0.70/layoutanimation.md#properties) to animate (optional, but recommended for `create` and `delete`)
...
Helper that creates an object (with `create`, `update`, and `delete` fields) to pass into [`configureNext`](versioned_docs/version-0.70/layoutanimation.md#configurenext). The `type` parameter is an [animation type](versioned_docs/version-0.70/layoutanimation.md#types), and the `creationProp` parameter is a [layout property](versioned_docs/version-0.70/layoutanimation.md#properties).
...
An enumeration of animation types to be used in the [`create`](versioned_docs/version-0.70/layoutanimation.md#create) method, or in the `create`/`update`/`delete` configs for [`configureNext`](versioned_docs/version-0.70/layoutanimation.md#configurenext). (example usage: `LayoutAnimation.Types.easeIn`)
...
An enumeration of layout properties to be animated to be used in the [`create`](versioned_docs/version-0.70/layoutanimation.md#create) method, or in the `create`/`update`/`delete` configs for [`configureNext`](versioned_docs/version-0.70/layoutanimation.md#configurenext). (example usage: `LayoutAnimation.Properties.opacity`)
...
A set of predefined animation configs to pass into [`configureNext`](versioned_docs/version-0.70/layoutanimation.md#configurenext).
