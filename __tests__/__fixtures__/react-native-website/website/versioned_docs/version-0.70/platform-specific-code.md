...
- Using the [`Platform` module](versioned_docs/version-0.70/platform-specific-code.md#platform-module).
- Using [platform-specific file extensions](versioned_docs/version-0.70/platform-specific-code.md#platform-specific-extensions).
