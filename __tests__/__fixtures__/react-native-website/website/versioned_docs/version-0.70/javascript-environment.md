...
- [`XMLHttpRequest`, `fetch`](versioned_docs/version-0.70/network.md#content)
- [`{set, clear}{Timeout, Interval, Immediate}, {request, cancel}AnimationFrame`](versioned_docs/version-0.70/timers.md#content)
