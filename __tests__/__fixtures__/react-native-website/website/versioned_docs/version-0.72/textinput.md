...
An optional identifier which links a custom [InputAccessoryView](versioned_docs/version-0.72/inputaccessoryview.md) to this text input. The InputAccessoryView is rendered above the keyboard when this text input is focused.
...
[Styles](versioned_docs/version-0.72/style.md)

| Type                                              |
| ------------------------------------------------- |
| [Text](versioned_docs/version-0.72/text.md#style) |
