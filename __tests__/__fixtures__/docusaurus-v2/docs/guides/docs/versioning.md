...
- Create a versioned sidebars file based from your current [sidebar](docs/guides/docs/docs-introduction.md#sidebar) configuration (if it exists) - saved as `versioned_sidebars/version-[versionName]-sidebars.json`.
...
See [docs plugin configuration](docs/api/plugins/plugin-content-docs.md#configuration) for more details.

## Navbar items {#navbar-items}

We offer several navbar items to help you quickly set up navigation without worrying about versioned routes.

- [`doc`](docs/api/themes/theme-configuration.md#navbar-doc-link): a link to a doc.
- [`docSidebar`](docs/api/themes/theme-configuration.md#navbar-doc-sidebar): a link to the first item in a sidebar.
- [`docsVersion`](docs/api/themes/theme-configuration.md#navbar-docs-version): a link to the main doc of the currently viewed version.
- [`docsVersionDropdown`](docs/api/themes/theme-configuration.md#navbar-docs-version-dropdown): a dropdown containing all the versions available.
