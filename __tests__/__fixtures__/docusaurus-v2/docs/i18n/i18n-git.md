...
This is a walk-through of using Git to translate a newly initialized English Docusaurus website into French, and assume you already followed the [i18n tutorial](docs/i18n/i18n-tutorial.md).
...
Use the [write-translations](docs/cli.md#docusaurus-write-translations-sitedir) CLI command to initialize the JSON translation files for the French locale:
...
To help you maintain the JSON translation files, it is possible to run again the [write-translations](docs/cli.md#docusaurus-write-translations-sitedir) CLI command:
