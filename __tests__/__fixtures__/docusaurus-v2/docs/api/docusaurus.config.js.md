...
The i18n configuration object to [localize your site](docs/i18n/i18n-introduction.md).
...
The [theme configuration](docs/api/themes/theme-configuration.md) object to customize your site UI like navbar and footer.
...
See [plugin method references](docs/api/plugin-methods/README.md) for the shape of a `PluginModule`.
...
An array of [client modules](docs/advanced/client.md#client-modules) to load globally on your site.
