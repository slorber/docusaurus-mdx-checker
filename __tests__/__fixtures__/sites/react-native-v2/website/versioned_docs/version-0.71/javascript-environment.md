...
- [`XMLHttpRequest`, `fetch`](versioned_docs/version-0.71/network.md#content)
- [`{set, clear}{Timeout, Interval, Immediate}, {request, cancel}AnimationFrame`](versioned_docs/version-0.71/timers.md#content)
