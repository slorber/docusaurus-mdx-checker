...
- Using the [`Platform` module](versioned_docs/version-0.71/platform-specific-code.md#platform-module).
- Using [platform-specific file extensions](versioned_docs/version-0.71/platform-specific-code.md#platform-specific-extensions).
