...
You might not want to use `<ImageBackground>` in some cases, since the implementation is basic. Refer to `<ImageBackground>`'s [documentation](versioned_docs/version-0.70/imagebackground.md) for more insight, and create your own custom component when needed.
