...
Pages do not have sidebars, only [docs](docs/guides/docs/docs-introduction.md) do.

:::

:::info

Check the [Pages Plugin API Reference documentation](docs/api/plugins/plugin-content-pages.md) for an exhaustive list of options.
