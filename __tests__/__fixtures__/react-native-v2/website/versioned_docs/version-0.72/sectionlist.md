...
If you don't need section support and want a simpler interface, use [`<FlatList>`](versioned_docs/version-0.72/flatlist.md).
...
### [VirtualizedList Props](versioned_docs/version-0.72/virtualizedlist.md#props)

Inherits [VirtualizedList Props](versioned_docs/version-0.72/virtualizedlist.md#props).
...
The actual data to render, akin to the `data` prop in [`FlatList`](versioned_docs/version-0.72/flatlist.md).

| Type                                                                    |
| ----------------------------------------------------------------------- |
| array of [Section](versioned_docs/version-0.72/sectionlist.md#section)s |
