...
1. [Record a Hermes sampling profile](versioned_docs/version-0.72/profile-hermes.md#record-a-hermes-sampling-profile)
2. [Execute command from CLI](versioned_docs/version-0.72/profile-hermes.md#execute-command-from-cli)
3. [Open the downloaded profile on Chrome DevTools](versioned_docs/version-0.72/profile-hermes.md#open-the-downloaded-profile-on-chrome-devtools)
...
:::info
You may read about source maps on the [source maps](versioned_docs/version-0.72/sourcemaps.md) page.
:::
...
- **How to fix** Follow the [instructions](versioned_docs/version-0.72/profile-hermes.md#record-a-hermes-sampling-profile) to enable/disable profiler from device.
