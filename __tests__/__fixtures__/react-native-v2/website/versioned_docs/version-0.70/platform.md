...
Since the value of the corresponding platform key can be of type `any`, [`select`](versioned_docs/version-0.70/platform.md#select) method can also be used to return platform-specific components, like below:
