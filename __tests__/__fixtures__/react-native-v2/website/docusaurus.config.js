...
const users = require("tests/fixtures/react-native-website/website/showcase.json");
...
module.exports = {
  ...
  themeConfig:
    ...
    ({
      ...
      prism: {
        defaultLanguage: "jsx",
        theme: require("tests/fixtures/react-native-website/website/core/PrismTheme"),
        additionalLanguages: [
          "java",
          "kotlin",
          "objectivec",
